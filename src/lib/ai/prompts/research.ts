const CATEGORY_HINTS: Record<string, string> = {
  development: "This is a developmental question. Focus on what's typical at this age and what caregivers can observe and support.",
  activities:  "This is an activity request. Suggest specific, low-prep, screen-free activities well-suited to the age and context.",
  milestones:  "This is a milestone question. Be concrete about what's expected now, what's coming next, and what signals readiness.",
}
...
export const researchPrompt = (input: {
  ...
  const hint = input.category ? (CATEGORY_HINTS[input.category] ?? "") : ""
...
{
  "headline": "4-7 word title capturing the core answer — not the question restated. Warm, direct.",
