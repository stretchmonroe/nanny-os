...
-- ── Child profile extension tables (Layer 2) ──────────────────────────────────
-- Referenced by seed.ts Layer 2. Run after the children table exists.
...
-- ── Activity planning tables (Layer 3) ────────────────────────────────────────
...
-- ── Grocery & household operations tables (Layer 5) ──────────────────────────
...
-- ── Realism and interaction tables (Layer 7) ─────────────────────────────────
...
-- ── AI insight and developmental intelligence tables (Layer 6) ───────────────
